...
const ViewCode = () => {
  ...
  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText(he.decode(code.description));
      setCopied(true);
  ...
  return !loader ? (
    <Container className="home-container">
      ...
      <Row className="mt-5">
        <Col xs={12} className="mt-3">
         {/* Copy Button (Correctly Positioned) */}
        <Button
              variant="dark"
              size="sm"
              onClick={copyToClipboard}
              className="position-absolute top-1 end-2 d-flex align-items-center gap-1"
            >
          ...
          <SyntaxHighlighter
            ...
            wrapLongLines={true} // ✅ Wraps long lines automatically
            wrapLines={true} // ✅ Ensures line breaks
          >
            {he.decode(code.description)}
          </SyntaxHighlighter>
        </Col>
      </Row>
    </Container>
